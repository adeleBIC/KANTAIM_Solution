...
{
    public partial class DataProdPge
    {
        ...
        private void OnDateChanged()
        {
            ...
            foreach (DataProdVM item in DataProds.Where(vm => vm.IsEditing).ToList())
            {
                item.DateProd = date.Value;
            }
                RefreshData();
        }
        ...
        async Task SaveAsync()
        {
            foreach (DataProdVM vm in DataProds.Where(vm => vm.IsEditing))
            {
                ...
                {
                    vm.DateExtract = DateTime.Now;
                    vm.DateProd = date.Value;
